...
<div class="page-wrapper">
    <div data-collapse="medium" data-animation="default" data-duration="400"
         data-w-id="c9165616-9eab-a65b-931e-d85daaec94af" data-easing="ease" data-easing2="ease" role="banner"
         class="navbar w-nav">
                ...
                <nav role="navigation" class="nav-menu w-nav-menu"><a href="/" aria-current="page"
                    ...
                    <div data-hover="false" data-delay="0" data-w-id="c9165616-9eab-a65b-931e-d85daaec94b7"
                        ...
                        <div class="nav-dropdown-toggle w-dropdown-toggle">
                            <div>Insurance plans</div>
                            <div class="nav-dropdown-icon-wrapper">
                                <div class="dropdown-icon-left"></div>
                    ...
                    <div data-hover="false" data-delay="0" data-w-id="ff511c50-bf0e-f77f-2e49-9b5e5908ae14"
                         class="nav-dropdown w-dropdown">
                        <div class="nav-dropdown-toggle w-dropdown-toggle">
                            <div>Quotes</div>
                            <div class="nav-dropdown-icon-wrapper">
...
<div class="section hero-section wf-section">
    <div class="container w-container">
        <div class="content-row home-v1">
            <div class="content">
                <div class="align-center">
                    <div class="home-hero-content">
                        <div class="small">
                            <h1>Get <span class="accent-text">premium insurance</span> and feel rest assured.
                            </h1>
                            <p><strong>Tutum</strong> offers a large range of premium insurance packages at
                                <strong>affordable prices</strong>. Start an <strong>online quote</strong> or
                                have a representative call you back. It’s that simple.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="content">
                <div class="image-wrapper"><img
                        src="https://assets.website-files.com/6003adccc6d98986390f8e7b/602663eeb6ca566b3b42b806_pexels-ketut-subiyanto-4473398.jpg"
                        loading="lazy"
        ...
        <div class="small-product-wrapper">
            <div class="content-row small-products-row">
...
<div class="second-background">
    <div class="awards-strip-wrapper">
    ...
    <div class="container w-container">
        ...
        <div class="content-row service-cards">
            <div class="card-group">
                <div class="card-trigger"><a href="/insurance-plans/life-insurance"
            ...
            <div class="card-group">
                <div class="card-trigger"><a href="/insurance-plans/travel"
                                             class="card product-large w-inline-block">
                    <div><img
                            src="https://assets.website-files.com/6003adccc6d98986390f8e7b/60d193491e5a4a7ae3fdb4c5_travel-icon.svg"
...
<div class="about-us-content">
    <div class="texture-set-about-left">
        <div class="texture-e"></div>
        <div class="texture-f"></div>
        <div class="texture-g"></div>
    </div>
    <div class="section wf-section">
        <div class="container w-container">
            <div class="content-row">
                <div class="content"><img
                        src="https://assets.website-files.com/6003adccc6d98986390f8e7b/60d2998717eb333783c51eb9_pexels-fauxels-3184429.jpg"
                        loading="lazy"
                ...
                <div class="content">
                    <div class="align-center">
                        <div class="card empty">
                            <div class="small">
                                <p class="pretitle">protecting the future</p>
                                <h2>Why <span class="accent-text">Tutum</span> insurance?</h2>
                                <p><strong>Tutum</strong> offers a large range of premium insurance packages at
                                    affordable prices. Start an online quote or have a representative call you
                                    back. It’s that simple.</p>
                                <div class="button-wrapper"><a href="#testimonials" class="button w-button">What
                                    people think</a></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-row">
                    <div class="content">
                        <div class="align-center">
                            <div class="card empty">
                                <div class="small">
                                    <p class="pretitle">changing lives</p>
                                    <h2><span class="accent-text">Modern</span> insurance template</h2>
                                    <p><strong>Tutum</strong> offers a large range of premium insurance packages
                                        at affordable prices. Start an online quote or have a representative
                                        call you back. It’s that simple.</p>
                                    <div class="button-wrapper"><a href="/loyalty-program"
                                                                   class="button w-button">loyalty program</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="content first"><img
                            src="https://assets.website-files.com/6003adccc6d98986390f8e7b/60d299879d54b46ef21a1295_pexels-fauxels-3184428.jpg"
                            loading="lazy"
        ...
        <div data-w-id="f8d0a61e-e83a-ca67-8d71-aa155a7c7d1c" class="texture-c"></div>
        <div data-w-id="f8d0a61e-e83a-ca67-8d71-aa155a7c7d1d" class="texture-l"></div>
    </div>
    <div class="texture-set-about-right">
        <div class="texture-j"></div>
        <div class="texture-i"></div>
        <div class="texture-k"></div>
    </div>
</div>
    ...
    <div class="container w-container">
        <div class="section-header">
            <div class="content">
                <h2>Our insights</h2>
                <div class="medium">
                    <p>Over the years we have gained some experience. Every week we like to share them with you.
                        Check in with our blog.</p>
                </div>
            </div>
        </div>
        <div class="content-row">
            <div class="content">
                <div class="blog-collection-list-wrapper w-dyn-list">
                    <div role="list" class="blog-collection-list w-dyn-items w-row">
                        <div role="listitem" class="blog-item w-dyn-item w-col w-col-4"><a
                                data-w-id="f78933ac-46f3-24dd-bc6f-c7906f5a641f"
                                href="/post/10-things-nobody-told-you-about-being-a-web-designer"
                                class="blog-thumbnail-wrapper w-inline-block"><img
                                src="https://assets.website-files.com/602fa7803da553f06a36c805/602fa788eee201cf4814f5c5_1613735811675-image2.jpg"
                                loading="lazy"
                        ...
                        <div role="listitem" class="blog-item w-dyn-item w-col w-col-4"><a
                                data-w-id="f78933ac-46f3-24dd-bc6f-c7906f5a641f"
                                href="/post/the-worst-advice-weve-ever-heard-about-web-design"
                                class="blog-thumbnail-wrapper w-inline-block"><img
                                src="https://assets.website-files.com/602fa7803da553f06a36c805/602fa7848739556a92a97b75_1613735811799-image4.jpg"
                                loading="lazy"
                                style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
                                alt=""
                                sizes="(max-width: 479px) 100vw, (max-width: 767px) 84vw, (max-width: 991px) 29vw, 28vw"
                        ...
                        <div role="listitem" class="blog-item w-dyn-item w-col w-col-4"><a
                                data-w-id="f78933ac-46f3-24dd-bc6f-c7906f5a641f"
                                href="/post/5-principles-of-effective-web-design"
                                class="blog-thumbnail-wrapper w-inline-block"><img
                        ...
                        <div role="listitem" class="blog-item w-dyn-item w-col w-col-4"><a
                                ...
                                class="blog-thumbnail-wrapper w-inline-block"><img
                                src="https://assets.website-files.com/602fa7803da553f06a36c805/60dd7cd4c762ce33314b1db9_1625128147534-image16.jpg"
                                loading="lazy"
                                style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
                                alt=""
                                sizes="(max-width: 479px) 100vw, (max-width: 767px) 84vw, (max-width: 991px) 29vw, 28vw"
                        ...
                        <div role="listitem" class="blog-item w-dyn-item w-col w-col-4"><a
                                ...
                                class="blog-thumbnail-wrapper w-inline-block"><img
                                src="https://assets.website-files.com/602fa7803da553f06a36c805/602fa7844b4bc53be888fa65_1613735811798-image14.jpg"
                                loading="lazy"
                                style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
                                alt=""
                                sizes="(max-width: 479px) 100vw, (max-width: 767px) 84vw, (max-width: 991px) 29vw, 28vw"
                ...
                <div class="button-wrapper centered"><a href="#" class="button w-button">see all insights</a>
                </div>
            </div>
        </div>
    </div>
    <div data-w-id="0f9f716a-4c36-83cb-ba1b-81d8aa7944de" class="texture-m"></div>
</div>
<div class="gradient-fill">
    <div id="loyalty" class="section wf-section">
        <div class="container w-container">
            <div class="section-header center">
                <div class="content small">
                    <h2>Loyalty programs that reward healthy living</h2>
                    <p class="large-body">When you signup for <strong>Tutum</strong> insurance you get access to
                        <strong>these benefits</strong>
                    </p>
                </div>
            </div>
            <div class="content-row center">
                <div class="content medium">
                    <div class="benefit-list-wrapper">
                        ...
                        <div class="super-small">
                            <h3 class="size-6">10% off healthclubs</h3>
                            <p class="small-body">Membership to healthclubs as become a lot more accessible
                                thanks to Tutum rewards.</p>
                        </div>
                    </div>
                </div>
                <div class="content medium">
                    <div class="benefit-list-wrapper right">
                        <div class="dot"></div>
                        <div class="super-small">
                            <h3 class="size-6">20x big points</h3>
                            <p class="small-body">Score big time whenever you purchase from grocery stores.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="content-row center">
                <div class="content medium">
                    <div class="benefit-list-wrapper">
                        <div class="dot"></div>
                        <div class="super-small">
                            <h3 class="size-6">Free BMI health checks</h3>
                            <p class="small-body">Membership to healthclubs as become a lot more accessible
                                thanks to Tutum rewards.</p>
                        </div>
                    </div>
                ...
                <div class="content medium">
                    <div class="benefit-list-wrapper right">
                        <div class="dot"></div>
                        <div class="super-small">
                            <h3 class="size-6">Extra cover for families</h3>
                            <p class="small-body">Membership to healthclubs as become a lot more accessible
                                thanks to Tutum rewards.</p>
                        </div>
                    </div>
        ...
        <div class="texture-set-products-left">
            <div class="texture-j"></div>
            <div class="texture-i"></div>
            <div class="texture-k"></div>
        </div>
        <div class="texture-set-product-right">
            <div class="texture-e"></div>
            <div class="texture-f"></div>
            <div class="texture-g"></div>
        </div>
    ...
    <div class="section no-top-padding wf-section">
        <div class="container w-container">
            <div class="w-layout-grid grid-2-col">
                <div id="w-node-eea6b66b-d295-8927-d098-35a655268a6a-55268a67" class="card faq-card">
                    <h6>FAQ</h6>
                    <div class="super-small">
                        <p class="small-body">Before you call us, maybe your questions have already been
                            answered.</p>
                    </div>
                    <div class="button-wrapper half-margin-wrapper"><a href="/faq" class="button border w-button">go
                        to faq</a></div>
                </div>
                <div id="w-node-eea6b66b-d295-8927-d098-35a655268a73-55268a67" class="card">
                    <div class="spaced-between">
                        ...
                        <div data-enable-scroll="true" data-enable-touch="true" data-widget-latlng=""
                             data-widget-tooltip="" data-widget-style="roadmap" data-widget-zoom="12" title=""
                             class="small-map w-widget w-widget-map"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="half-secondary-background"></div>
    </div>
</div>
    ...
    <div class="container w-container">
        <div class="footer-flex-container">
            ...
            <div class="footer-nav-wrapper">
                <div class="footer-van-content">
                    <h2 class="footer-heading">Insurance</h2>
                    <ul role="list" class="w-list-unstyled">
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e4b"
                               href="/insurance-plans/home-insurance" class="footer-link w-inline-block">
                            <div>Home insurance</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e51"
                               href="/insurance-plans/car-insurance" class="footer-link w-inline-block">
                            <div>Car insurance</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="69c154cf-e03a-7198-bdc1-4b52ac139676"
                               href="/insurance-plans/health-insurance" class="footer-link w-inline-block">
                            <div>Health insurance</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="631fd1f6-aa79-cc89-4ab6-e1f490e5b671" href="/insurance-plans/travel"
                               class="footer-link w-inline-block">
                            <div>Travel insurance</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a href="/insurance-plans/life-insurance" class="footer-link w-inline-block">
                ...
                <div class="footer-van-content">
                    <h2 class="footer-heading">For you</h2>
                    <ul role="list" class="w-list-unstyled">
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e5b" href="/claims"
                               class="footer-link w-inline-block">
                            <div>Claims</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e61" href="/emergency-contacts"
                               class="footer-link w-inline-block">
                            <div>Emergency services</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e67" href="/loyalty-program"
                               class="footer-link w-inline-block">
                            <div>Loyalty program</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e6d" href="/blog"
                               class="footer-link w-inline-block">
                            <div>Blog insights</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="6e00630c-ee5a-8990-58c1-04dd22a5cb52" href="/faq"
                               class="footer-link w-inline-block">
                            <div>FAQ</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                ...
                <div class="footer-van-content">
                    ...
                    <ul role="list" class="w-list-unstyled">
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e77" href="/about-us"
                               class="footer-link w-inline-block">
                            <div>About us</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e7d" href="/about-us"
                               class="footer-link w-inline-block">
                            <div>Benefits</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e83" href="/about-us"
                               class="footer-link w-inline-block">
                            <div>Awards</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
                        </a></li>
                        <li><a data-w-id="f445f800-9e8b-2ebe-6a1b-0bddc58c7e89" href="/contact-us"
                               class="footer-link w-inline-block">
                            <div>Contact us</div>
                            <div class="footer-link-hover"></div>
                            <div class="footer-link-hover light-line"></div>
...
<script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=6003adccc6d98986390f8e7b"
